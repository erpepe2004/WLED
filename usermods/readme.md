...
Si ha creado un usermod que cree que es útil (por ejemplo, para soportar un sensor particular, pantalla, característica...), ¡siéntase libre de contribuir abriendo una request de extracción!
...
* ¡Cree una request de extracción!  
