...
const dictionary = {
  ...
  'connect': 'conectar', 'disconnect': 'desconectar', 'send': 'send',
  ...
  'index': 'index', 'offset': 'desplazamiento', 'position': 'posición',
  'size': 'tamaño', 'length': 'length', 'count': 'conteo', 'value': 'valor',
  'variable': 'variable', 'constant': 'const', 'parameter': 'parámetro',
  'argument': 'argumento', 'return': 'return', 'result': 'resultado',
  ...
  'server': 'servidor', 'client': 'cliente', 'request': 'request',
  'response': 'respuesta', 'status': 'estado', 'state': 'estado', 'code': 'código',
  'message': 'mensaje', 'data': 'data', 'payload': 'carga útil', 'header': 'encabezado',
  ...
  'integer': 'entero', 'float': 'flotante', 'double': 'doble', 'string': 'String',
  'character': 'carácter', 'boolean': 'booleano', 'true': 'true',
  'false': 'false', 'null': 'nulo', 'undefined': 'indefinido', 'overflow': 'desbordamiento',
  ...
  'fork': 'bifurcación', 'clone': 'clon', 'pull': 'extraer', 'push': 'send',
  ...
  'const': 'const', 'mutable': 'mutable', 'inline': 'en línea',
  'virtual': 'virtual', 'override': 'override', 'end': 'end', 'operator': 'operador',
